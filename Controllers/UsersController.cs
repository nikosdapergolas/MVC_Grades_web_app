...
namespace VathmologioMVC.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(VathmologioDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Username,Password,Role")] User user)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    return View("Views/Professors/Create.cshtml");
                }
                else if (user.Role.Equals("Secretary"))
                {
                    return View("Views/Secretaries/Create.cshtml");
                }
            }
            return View(user);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'VathmologioDbContext.Users'  is null.");
            }
            var user = await _context.Users.FindAsync(id);
            if (user != null)
            {
